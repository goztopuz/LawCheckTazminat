  ...
  public  class MaasOranlaViewModel:ViewModelBase
    {
        ...
        private DestektenYoksunluk _dyy;
        public DestektenYoksunluk DYY
        {
            get => _dyy;
        ...
        async private void OnKullan(object obj)
        {
            ...
            ao.maasBrut = BrutUcret;
            ao.oran = Oran;

            MessagingCenter.Send<AsgariOran>(ao, "OranlaNetAsgari");
        ...
        private decimal AgiHesapla()
        {
            ...
            foreach (var t in DYY.DestekYoksunlukYakinlar)
            {
                if (t.yakinlik == "Eş")
                {
    ...
    public class AsgariOran
    {

      public  decimal maas;
        public decimal maasBrut;
     public   decimal oran;
    }
}
