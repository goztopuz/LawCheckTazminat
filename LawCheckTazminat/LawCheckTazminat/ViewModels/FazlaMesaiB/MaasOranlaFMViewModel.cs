...
{
    public class MaasOranlaFMViewModel :ViewModelBase
    {
        ...
        public MaasOranlaFMViewModel(FazlaMesai _fm, List<AsgariUcretTablosu> aL)
        {
            aL2 = aL;
            ...
            cocukSay = _fm.CocukSayisi;

            if(_fm.Bekar=="Evli")
            {
                if(_fm.EsCalisiyor== "ÇalışMIyor")
                {
                    esCalismaa = 0;
                }
            }
        ...
        async private void OnKullan(object obj)
        {
            ...
            MessagingCenter.Send<AsgariOran>(ao, "OranlaNetAsgariFM");
