...
{
    public class MaasOranlaViewIsgucuModel:ViewModelBase
    {
        public MaasOranlaViewIsgucuModel(IsgucuKayip _kayip, List<AsgariUcretTablosu> aL)
        {
        ...
        private IsgucuKayip _iG;
        public IsgucuKayip IG
        {
            get => _iG;
            set
            {
        ...
        async private void OnKullan(object obj)
        {
            ...
            MessagingCenter.Send<AsgariOran>(ao, "OranlaNetAsgariIsgucu");
        ...
        private decimal AgiHesapla()
        {
            ...
            foreach (var t in IG.IsGucuKayipYakinlar)
            {
                if (t.yakinlik == "Eş")
                {
