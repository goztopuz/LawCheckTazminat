...
{
    public class MaasOranlaGCBrutViewModel : ViewModelBase
    {
        List<AsgariUcretTablosu> aL2 = new List<AsgariUcretTablosu>();

        public MaasOranlaGCBrutViewModel(GeceCalisma _gc, List<AsgariUcretTablosu> aL)
        {
            aL2 = aL;
        ...
        async private void OnKullan(object obj)
        {
            ...
            ao.maas = BrutMaas;
            ao.oran = Oran;
            MessagingCenter.Send<AsgariOran>(ao, "OranlaBrutAsgariGC");
            await Application.Current.MainPage.Navigation.PopModalAsync();
